...
#---------------------------------------------------------------------------------------------
#   Description: Waveform synthesis from the estimated parameters
#                synthesisRequiem is new  waveform generator method from WORLD version 0.2.2 against synthesis
#                Input
